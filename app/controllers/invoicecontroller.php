...
class InvoiceController
{
	...
	public function index()
	{
		...
		foreach ($_SESSION["reservations"] as $events=>$values) {
				...
				$pdf->Cell(25, 6, chr(128) . ' ' . number_format($values['price'], 2, ',', '.'), 1, 1, 'R');
	...
	Please see attached for Haarlem festival invoice, due on. Do not hesitate to reach out if you have any questions.<br> <br>
